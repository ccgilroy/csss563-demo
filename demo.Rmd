...
Copyright (c) 2020 Connor Gilroy. MIT Licensed. Full license terms [here](https://github.com/ccgilroy/csss563-demo/blob/master/LICENSE).
...
wb_path <- str_c("v2", "country", "ca", sep = "/")
...
```{r}
wb_path_2 <- str_c("v2", "country", "ca", "indicators", "SP.POP.TOTL", sep = "/")
