...
), and [Chris Bail](https://cbail.github.io/textasdata/screenscraping/rmarkdown/Screenscraping_in_R.html).
...
ts_plot(searched_tweets, by = "min")
```

## Alternative Twitter package - `streamR`

There's a slightly older package for accessing the Twitter Streaming API called `streamR`, written by Pablo Barberá. If `rtweets` doesn't work out for some of you, we'll have a look at this code as an alternative.
